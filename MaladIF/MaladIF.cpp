...
// MaladIF.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CMaladIFApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CMaladIFApp

CMaladIFApp::CMaladIFApp()
{
...
// Seul et unique objet CMaladIFApp

CMaladIFApp theApp;


// initialisation de CMaladIFApp

BOOL CMaladIFApp::InitInstance()
{
